...
type AnalyticsTextSection = {
  paragraphs: string[];
};

type AnalyticsListSection = {
  items: string[];
};

type AnalyticsProjectSectionProps = {
  id: string;
  title: string;
  section: AnalyticsTextSection | AnalyticsListSection;
};

function isTextSection(section: AnalyticsTextSection | AnalyticsListSection): section is AnalyticsTextSection {
  return "paragraphs" in section;
}

export function AnalyticsProjectSection({ id, title, section }: AnalyticsProjectSectionProps) {
